...
import handlePostRequest from '../../services/handlePostRequest'
function ContactUs() {
    ...
    const formik = useFormik({
        ...
        initialValues: {
            ...
            const response = await handlePostRequest("https://jsonplaceholder.typicode.com/posts", data);
            console.log(response)
        }
    })
    const getUserData = async () => {
        const response = await handleGetRequest("https://jsonplaceholder.typicode.com/posts/1")
        setGetData(response.body)
    }
            ...
            <section id='contact' className='container section'>
                ...
                <div className='row mt-4 align-items-center justify-content-between '>
                    <div className='col-lg-6 text-center'>
                        ...
                        <p className='text-grey my-3'>{getData}</p>
